...
$misAmigos = ["Fran", "Edward", "Kevin"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Emilio", "Alison"); // Reemplaza las comillas vacías con los nombres de tus amigos
