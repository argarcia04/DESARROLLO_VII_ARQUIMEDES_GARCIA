...
echo "
La suma de los decimales es: " . round($sumaDecimales, 2) . "
";
...
echo "
Total de ventas de la semana: $" . number_format($totalVentas, 2) . "
";
...
echo "
Promedio de calificaciones: " . round($promedio, 2) . "
";
...
echo "
Total de gastos en el trimestre: $" . number_format($totalGastos, 2) . "
";
...
echo "
Suma de números pares: " . sumaPares($numeros) . "
";
...
echo "
Total de impuestos a pagar: $" . number_format($totalImpuestos, 2) . "
";
?>
