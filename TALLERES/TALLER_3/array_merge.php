...
$misComidas = ["Pizza", "Arroz", "Pollo"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Galletas", "Albondigas", "Coditos"]; // Reemplaza con las comidas favoritas de tu amigo
